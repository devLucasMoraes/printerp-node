...
export class Default1740531987074 implements MigrationInterface {
    name = 'Default1740531987074'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categorias" ("id" SERIAL NOT NULL, "nome" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "user_id" character varying(255), CONSTRAINT "UQ_de8a2d8979f7820616e31dc1e15" UNIQUE ("nome"), CONSTRAINT "PK_3886a26251605c571c6b4f861fe" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "insumos" ("id" SERIAL NOT NULL, "descricao" character varying(255) NOT NULL, "valor_unt_med" numeric(10,2) NOT NULL DEFAULT '0', "valor_unt_med_auto" boolean NOT NULL DEFAULT false, "permite_estoque_negativo" boolean NOT NULL DEFAULT false, "und_estoque" "public"."insumos_und_estoque_enum" NOT NULL, "estoque_minimo" numeric(10,2) NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "user_id" character varying(255), "categoria_id" integer, CONSTRAINT "PK_b4e1b727a7b140e698e3a3dc7af" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "equipamentos" ("id" SERIAL NOT NULL, "nome" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "user_id" character varying(255), CONSTRAINT "UQ_cad18a4ac93dbd783fb793b9d01" UNIQUE ("nome"), CONSTRAINT "PK_0db94e9eed96824cb4446343a86" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "requisitantes" ("id" SERIAL NOT NULL, "nome" character varying(255) NOT NULL, "fone" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "user_id" character varying(255), CONSTRAINT "UQ_a5d6feb6a5bf80161d307bc865b" UNIQUE ("nome"), CONSTRAINT "PK_217e259327009b9ee87821bc07e" PRIMARY KEY ("id"))`);
